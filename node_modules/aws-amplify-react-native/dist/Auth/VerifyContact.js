  ...
  _createClass(VerifyContact, [{
    ...
    value: function createPicker(unverified) {
      ...
      if (email && phone_number) {
        return /*#__PURE__*/_react["default"].createElement(_reactNative.Picker, {
          ...
          testID: _AmplifyTestIDs["default"].AUTH.VERIFY_CONTACT_PICKER
    ...
    value: function verifyBody(theme) {
      ...
      }, this.createPicker(unverified), /*#__PURE__*/_react["default"].createElement(_AmplifyUI.AmplifyButton, {
        theme: theme,
        text: _awsAmplify.I18n.get('Verify'),
        onPress: this.verify,
        disabled: !this.state.pickAttr,
        testID: _AmplifyTestIDs["default"].AUTH.VERIFY_BUTTON
      }));
    }
  }, {
    key: "submitBody",
    value: function submitBody(theme) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
        ...
        testID: _AmplifyTestIDs["default"].AUTH.SUBMIT_BUTTON
      }));
    }
  }, {
    key: "showComponent",
